...
desc 'Generate documentation for the payflow extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'PayflowExtension'
...
desc 'Test the payflow extension.'
...
namespace :test do
  desc 'Functional test the payflow extension.'
  ...
  desc 'Unit test the payflow extension.'
